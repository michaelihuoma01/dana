...
//     _caller = await DatabaseService.getUserWithId(widget.call.callerId);
//     _receiver = await DatabaseService.getUserWithId(widget.call.receiverId);
//   }
...
//         if (widget.call.receiverId != friends.id) {
//           setState(() {
//             isFriends = true;
